...
DataTypeTransition rtBTransitions [ ] = { { ( char_T * ) ( & rtB . egc3dkjd1t
) , 0 , 0 , 36 } , { ( char_T * ) ( & rtDW . nx1a3wswtk ) , 0 , 0 , 2 } } ;
static DataTypeTransitionTable rtBTransTable = { 2U , rtBTransitions } ;
static DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
commutationMatrix [ 0 ] ) , 0 , 0 , 1542 } } ; static DataTypeTransitionTable
