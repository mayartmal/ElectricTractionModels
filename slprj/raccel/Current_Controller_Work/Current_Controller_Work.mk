...
MODEL                  = Current_Controller_Work
MODULES                = Current_Controller_Work_capi.c Current_Controller_Work_data.c Current_Controller_Work_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c rt_logging.c
MAKEFILE               = Current_Controller_Work.mk
MATLAB_ROOT            = /usr/local/MATLAB/R2017a
ALT_MATLAB_ROOT        = /usr/local/MATLAB/R2017a
MATLAB_ROOTQ           = \"/usr/local/MATLAB/R2017a\"
MASTER_ANCHOR_DIR      = 
START_DIR              = /home/mayartmal/matlab/Train_Models
...
MODELLIB                  = Current_Controller_Worklib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/slprj/raccel/Current_Controller_Work \
